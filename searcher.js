...
ctx.help = function() {
    ...
    '    - Currently, the only types supported are the following:  contact, message, and status\n'+
    ...
    '        contact:  {"_id":<integer>, "name":<string>, "nickname":<string>, "email":[{"type":<string>, "value":<string>}]}\n'+
